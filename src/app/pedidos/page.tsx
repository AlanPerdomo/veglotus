...
export default function Pedidos() {
  ...
  return (
    <div className=" bg-gray-100 sm:p-4 p-1">
      <div className="max-w-screen sm:mx-auto sm:p-8">
        <div className="bg-white shadow-lg rounded-lg flex flex-1 flex-col border-gray-200 border sm:pl-4 pl-2 sm:pr-4 pr-2">
          <h1 className="text-lg sm:text-4xl font-bold text-center text-black m-4 sm:m-8">Meus Pedidos</h1>
          {isLoading ? (
            <div className="flex justify-center items-center h-72"> carregando...</div>
          ) : pedidos.length === 0 ? (
